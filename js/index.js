...
let path21 = document.getElementById('패스_21');
    ...
    btnw.onclick = function() {
        ...
        btnw.style.boxShadow = "4px -1px 3px rgba(0, 0, 0, 0.2)";
        btnc.style.boxShadow = "4px 1px 3px rgba(0, 0, 0, 0.2) inset";
    ...
    btnc.onclick = function() {
        ...
        btnc.style.boxShadow = "4px 1px 3px rgba(0, 0, 0, 0.2)";
        btnw.style.boxShadow = "4px -1px 3px rgba(0, 0, 0, 0.2) inset";
